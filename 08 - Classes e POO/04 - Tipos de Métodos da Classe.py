...
Úteis em cenários específicos, como por exemplo, modificar  como uma classe é 
instanciada, através de novos construtores personalizados. 
...
São os métodos que não utilizam a instância da classe através do 'self' e também não 
modificam as propriedades da classe através do 'cls'. 

São úteis para criar uma classe onde serão agrupadas funcionalidades relacionadas à 
um tema específico.
...
# Computador marca Dell, com 8gb de memória RAM, placa de vídeo Placa de Vídeo de
# Baixo Custo e sistema operacional Windows 11
computador_hardcore.exibir_dados_do_computador()
# Computador marca Dell, com 32gb de memória RAM, placa de vídeo Placa de Vídeo
# Alto Nível e sistema operacional Windows 11
