...
Ao contrário das listas, as tuplas não podem ser modificadas após a criação, 
o que as torna adequadas para representar coleções de valores constantes, 
como coordenadas ou informações relacionadas.
'''
